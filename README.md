A heart disease prediction model trained on dataset having details about a persons medical history and predicts if a person has heart disease or not based on the given data
